...
const YouTubeSection: React.FC<YouTubeSectionProps> = ({ keyword, shouldFetch }) => {
  ...
  useEffect(() => {
    ...
    const fetchYouTubeData = async () => {
      ...
      try {
        ...
        setError(prev => ({ ...prev, videos: err instanceof Error ? err.message : 'Unknown error' }));
      } finally {
      ...
      try {
        ...
        setError(prev => ({ ...prev, sentiment: err instanceof Error ? err.message : 'Unknown error' }));
      } finally {
      ...
      try {
        ...
        setError(prev => ({ ...prev, tags: err instanceof Error ? err.message : 'Unknown error' }));
      } finally {
